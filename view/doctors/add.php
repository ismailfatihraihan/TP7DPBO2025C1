...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $doctorId = $doctor->create($data);
        
        if ($doctorId) {
            setFlashMessage('success', 'Doctor added successfully');
            redirect(baseUrl() . '/view/doctors/view.php?id=' . $doctorId);
        } else {
...
<form action="" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="text" id="specialization" name="specialization" required value="<?php echo isset($_POST['specialization']) ? $_POST['specialization'] : ''; ?>">
    </div>
    
    <div class="form-group">
        <label for="qualification">Qualification *</label>
        <input type="text" id="qualification" name="qualification" required value="<?php echo isset($_POST['qualification']) ? $_POST['qualification'] : ''; ?>">
    </div>
